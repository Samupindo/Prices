...
class ShopServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        shopService = new ShopServiceImpl(productInShopRepository, shopLocationRepository, Mappers.getMapper(ShopModelMapper.class), Mappers.getMapper(ProductInShopModelMapper.class), productRepository);
    }
    ...
    void testFindAllShopWithFiltersCity() {
        ...
        PageResponseTo<ShopTo> result = shopService.findAllShopWithFilters(null, cityFilter, null, pageable);
    ...
    void testFindAllShopWithFiltersAddress() {
        ...
        PageResponseTo<ShopTo> result = shopService.findAllShopWithFilters(null, null, addressFilter, pageable);
    ...
    void testFindAllShopWithFiltersMultipleFilters() {
        ...
        PageResponseTo<ShopTo> result = shopService.findAllShopWithFilters(countryFilter, cityFilter, addressFilter, pageable);
    ...
    void testAddProductToShop() {
        ...
        when(shopLocationRepository.findById(shopId)).thenReturn(Optional.of(shopModel));
        when(productInShopRepository.findByShop_ShopIdAndProduct_ProductId(shopId, productId)).thenReturn(Optional.empty());
        when(productInShopRepository.save(any(ProductInShopModel.class))).thenReturn(productInShopModel);
    ...
    void testAddProductToShopProductConflict() {
        ...
        when(productRepository.findById(productId)).thenReturn(Optional.of(productModel));
        when(shopLocationRepository.findById(shopId)).thenReturn(Optional.of(shopModel));
        when(productInShopRepository.findByShop_ShopIdAndProduct_ProductId(shopId, productId)).thenThrow(new ConflictException());
    ...
    void testUpdateProductPriceInShop() {
        ...
        when(productInShopRepository.findByShop_ShopIdAndProduct_ProductId(shopId, productId)).thenReturn(Optional.of(productInShopModel));
        when(productInShopRepository.save(any(ProductInShopModel.class))).thenReturn(productInShopModel);

        ProductInShopTo result = shopService.updateProductPriceInShop(shopId, productId, productInShopPatchTo);
